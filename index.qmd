...
Inspecionando as variáves, temos:

```{r}
str(dados)
```

A descrição de cada variável é conhecida:
...
Assim, devemos aplicar as seguintes transformações nas variáveis para que passem a ser categóricas como descrito acima:
